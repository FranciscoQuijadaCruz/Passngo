...
if(isset($_POST['sent'])) {
  ...
  if($resQueryUserDelete) {
    header("Location: cpaneladmin.php?deletedUser=true");
  }
...
<form action="delete_accounts.php?userId=<?php echo $userDetails['id'];?>" method="post" class="margen">
     
     <h1 class="iniciosesion">Eliminar Cuenta</h1>
