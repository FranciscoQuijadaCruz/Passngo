...
$queryGetEvents = "SELECT id, nombre, tipo, artistaOGrupo, imagen, precio, precioVip FROM evento WHERE tipo LIKE '$search'";
...
<head>
  ...
  <title>Pass 'N Go - Eventos <?php echo $eventDetail['tipo']; ?>.</title>
</head>
<body>
<?php
...
<div class="margenbusqueda">
  ...
  <h1>Eventos <?php echo $eventDetail['tipo']; ?>.</h1> 
  <div>       
