...
$queryGetUsers = "SELECT id, nombre, artistaOGrupo, imagen FROM papeleraevento";
// Ejecutamos el query
...
?>
<div class="listuser">
  <h1>Administrar papelera de eventos.</h1>
    ...
    <li class="liTarjeta">
      ...
      <p id="lbpreciosbusqueda"><a href="restaurar_evento.php?userId=<?php echo $userDetail['id'];?>">Restaurar</a> | <a href="eliminar_evento.php?userId=<?php echo $userDetail['id'];?>">Eliminar</a></p>
    </li>
